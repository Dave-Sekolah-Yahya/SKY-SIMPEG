...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Seeder Unit Kerja
        UnitKerja::create(['nama_unit' => 'TK',]);
        UnitKerja::create(['nama_unit' => 'SD',]);
        UnitKerja::create(['nama_unit' => 'SMP',]);
        UnitKerja::create(['nama_unit' => 'SMA',]);
        UnitKerja::create(['nama_unit' => 'IT',]);
        UnitKerja::create(['nama_unit' => 'KEUANGAN',]);
        UnitKerja::create(['nama_unit' => 'MARKETING',]);
        UnitKerja::create(['nama_unit' => 'SARPRAS',]);
