...
@section('title', 'SKY SIMPEG - Data Karyawan')
@section('konten')
            ...
            <div class="col-md">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab"
                        aria-controls="v-pills-profile" aria-selected="false">Suami Istri</a>
                    <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages"
                        role="tab" aria-controls="v-pills-messages" aria-selected="false">Anak</a>
                    <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings"
                        role="tab" aria-controls="v-pills-settings" aria-selected="false">Ortu</a>
                </div>
            </div>
            <!-- End Nav Link Profile -->
            ...
            <div class="col-md-2,5">
                <div class="card shadow mb-2">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <i class="fa fa-address-card"></i> {{ $pegawai->unitkerja->nama_unit }}
                        <hr>
                        <i class="fa fa-phone"></i> {{ $pegawai->no_telp }}
                        {{-- <hr>
    ...
    <!-- Modal Suami istri -->
    <div class="modal fade" id="ModalSuami" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <!-- Modal Anak -->
    <div class="modal fade" id="ModalAnak" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Modal Ortu -->
    <div class="modal fade" id="ModalOrtu" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="pills-tambah-tab" data-toggle="pill" href="#pills-tambah"
                                role="tab" aria-controls="pills-tambah" aria-selected="true">Tambah</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact"
                                role="tab" aria-controls="pills-contact" aria-selected="false">Hapus</a>
                        </li>
                    </ul>
                            ...
                            <div class="card p-3">
                                @if ($pegawai->riwayatdiklat->count() !== 0)
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            : @foreach ($pegawai->riwayatdiklat as $rd)
                                                <span class="badge badge-primary">{{ $rd->nama_diklat }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            : @foreach ($pegawai->riwayatdiklat as $rd)
                                                <span class="badge badge-success">{{ $rd->diklat->jenis_diklat }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            : @foreach ($pegawai->riwayatdiklat as $rd)
                                                <span class="badge badge-secondary">{{ $rd->tgl_mulai }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            : @foreach ($pegawai->riwayatdiklat as $rd)
                                                <span class="badge badge-warning">{{ $rd->tgl_selesai }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            : @foreach ($pegawai->riwayatdiklat as $rd)
                                                <span class="badge badge-danger">{{ $rd->no_sertifikat }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            : @foreach ($pegawai->riwayatdiklat as $rd)
                                                <span class="badge badge-dark">{{ $rd->thn_sertifikat }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            : @foreach ($pegawai->riwayatdiklat as $rd)
                                                <span class="badge badge-info">{{ $rd->penyelenggara }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="jenis_diklat" class="form-control" required>
                                            @foreach ($diklat as $dikl)
                                                <option value="{{ $dikl->kode_diklat }}">{{ $dikl->jenis_diklat }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <!-- form group -->
    ...
    <!-- start modal gapok -->
    <div class="modal fade" id="ModalGapok" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link" id="nav-hapus-tab" data-toggle="tab" href="#nav-hapus" role="tab"
                                aria-controls="nav-hapus" aria-selected="false">Hapus</a>
                        </div>
                    </nav>
                            ...
                            <div class="card p-3">
                                @if ($pegawai->riwayatgapok->count() !== 0)
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatgapok as $rg)
                                                <span class="badge badge-primary">{{ $rg->no_sk }} </span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatgapok as $rg)
                                                <span class="badge badge-primary"> {{ $rg->tgl_sk }} </span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatgapok as $rg)
                                                <span class="badge badge-primary">{{ $rg->pejabat_sk }} </span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatgapok as $rg)
                                                <span class="badge badge-primary">{{ $rg->tmt }} </span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatgapok as $rg)
                                                <span class="badge badge-primary">{{ $rg->ket }} </span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
    ...
    <!-- start modal hukuman -->
    <div class="modal fade" id="ModalHukuman" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-home-tab1" data-toggle="tab" href="#nav-home1"
                                role="tab" aria-controls="nav-home1" aria-selected="true">Home</a>
                            ...
                            <a class="nav-item nav-link" id="nav-hapus-tab1" data-toggle="tab" href="#nav-hapus1"
                                role="tab" aria-controls="nav-hapus1" aria-selected="false">Hapus</a>
                        </div>
                    </nav>
                    <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="card p-3">
                                @if ($pegawai->riwayatindisipliner->count() !== 0)
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatindisipliner as $rid)
                                                <span class="badge badge-primary">{{ $rid->hukuman }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatindisipliner as $rid)
                                                <span class="badge badge-primary">{{ $rid->no_sk }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatindisipliner as $rid)
                                                <span class="badge badge-primary">{{ $rid->tgl_sk }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatindisipliner as $rid)
                                                <span class="badge badge-primary">{{ $rid->pejabat_sk }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                            ...
                            <div class="card p-3">
                                @if ($pegawai->riwayatjabatan->count() !== 0)
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatjabatan as $rjbt)
                                                <span class="badge badge-primary">
                                                    {{ $rjbt->jabatanstruktural->nama_jabatan }} </span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatjabatan as $rjbt)
                                                <span class="badge badge-primary"> {{ $rjbt->no_sk }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatjabatan as $rjbt)
                                                <span class="badge badge-primary"> {{ $rjbt->tgl_sk }} </span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatjabatan as $rjbt)
                                                <span class="badge badge-primary">{{ $rjbt->pejabat_sk }} </span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatjabatan as $rjbt)
                                                <span class="badge badge-primary"> {{ $rjbt->tmt }} </span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatjabatan as $rjbt)
                                                <span class="badge badge-primary"> {{ $rjbt->ket }} </span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatjabatan as $rjbt)
                                                <span
                                                    class="badge badge-primary">{{ $rjbt->jabatanstruktural->ket }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="kode_jbts" class="form-control">
                                                @foreach ($jbts as $jb)
                                                    <option value="{{ $jb->kode_jbts }}">{{ $jb->nama_jabatan }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
    ...
    <div class="modal fade" id="ModalJabatanfungsional" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-home-tab3" data-toggle="tab" href="#nav-home3"
                                role="tab" aria-controls="nav-home3" aria-selected="true">Home</a>
                            <a class="nav-item nav-link" id="nav-profile-tab3" data-toggle="tab" href="#nav-profile3"
                                role="tab" aria-controls="nav-profile3" aria-selected="false">Tambah</a>
                            <a class="nav-item nav-link" id="nav-hapus-tab3" data-toggle="tab" href="#nav-hapus3"
                                role="tab" aria-controls="nav-hapus3" aria-selected="false">Hapus</a>
                        </div>
                    </nav>
                    <div class="tab-content" id="nav-tabContent">
                                ...
                                @if ($pegawai->riwayatjabatanf->count() !== 0)
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatjabatanf as $rjbtf)
                                                <span
                                                    class="badge badge-primary">{{ $rjbtf->jabatanfungsional->nama_jabatan }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatjabatanf as $rjbtf)
                                                <span
                                                    class="badge badge-primary">{{ $rjbtf->jabatanfungsional->level }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatjabatanf as $rjbtf)
                                                <span class="badge badge-primary"> {{ $rjbtf->jabatanfungsional->ket }}
                                                </span>
                                            @endforeach
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatjabatanf as $rjbtf)
                                                <span class="badge badge-primary">{{ $rjbtf->no_sk }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatjabatanf as $rjbtf)
                                                <span class="badge badge-primary"> {{ $rjbtf->tgl_sk }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatjabatanf as $rjbtf)
                                                <span class="badge badge-primary"> {{ $rjbtf->pejabat_sk }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatjabatanf as $rjbtf)
                                                <span class="badge badge-primary"> {{ $rjbtf->tmt }} </span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            : @foreach ($pegawai->riwayatjabatanf as $rjbtf)
                                                <span class="badge badge-primary">{{ $rjbtf->ket }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="kode_jbtf" class="form-control">
                                                @foreach ($jbtf as $j)
                                                    <option value="{{ $j->kode_jbtf }}">{{ $j->nama_jabatan }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active" id="nav-home-tab31" data-toggle="tab" href="#nav-home31"
                                role="tab" aria-controls="nav-home31" aria-selected="true">Home</a>
                            <a class="nav-item nav-link" id="nav-profile-tab31" data-toggle="tab" href="#nav-profile31"
                                role="tab" aria-controls="nav-profile31" aria-selected="false">Tambah</a>
                            <a class="nav-item nav-link" id="nav-hapus-tab31" data-toggle="tab" href="#nav-hapus31"
                                role="tab" aria-controls="nav-hapus31" aria-selected="false">Hapus</a>
                        </div>
                    </nav>
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home31" role="tabpanel"
                            aria-labelledby="nav-home-tab31">
                            <!-- start home jabatan lain -->
                            <div class="card p-3">
                                @if ($pegawai->riwayatjabatanft->count() !== 0)
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            : @foreach ($pegawai->riwayatjabatanft as $rjbtft)
                                                <span
                                                    class="badge badge-primary">{{ $rjbtft->jabatanfungsionalt->tugas_tambahan }}
                                                </span>
                                            @endforeach
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            : @foreach ($pegawai->riwayatjabatanft as $rjbtft)
                                                <span
                                                    class="badge badge-primary">{{ $rjbtft->jabatanfungsionalt->jabatan }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            : @foreach ($pegawai->riwayatjabatanft as $rjbtft)
                                                <span
                                                    class="badge badge-primary">{{ $rjbtft->jabatanfungsionalt->level }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            : @foreach ($pegawai->riwayatjabatanft as $rjbtft)
                                                <span
                                                    class="badge badge-primary">{{ $rjbtft->jabatanfungsionalt->ket }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            : @foreach ($pegawai->riwayatjabatanft as $rjbtft)
                                                <span class="badge badge-primary">{{ $rjbtft->no_sk }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            : @foreach ($pegawai->riwayatjabatanft as $rjbtft)
                                                <span class="badge badge-primary">{{ $rjbtft->tgl_sk }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            : @foreach ($pegawai->riwayatjabatanft as $rjbtft)
                                                <span class="badge badge-primary">{{ $rjbtft->pejabat_sk }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            : @foreach ($pegawai->riwayatjabatanft as $rjbtft)
                                                <span class="badge badge-primary">{{ $rjbtft->tmt }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="kode_jbtft" class="form-control">
                                                @foreach ($jbtft as $j)
                                                    <option value="{{ $j->kode_jbtft }}">{{ $j->tugas_tambahan }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                            ...
                            @if ($pegawai->riwayatjabatanft->count() !== 0)
                                ...
                                @foreach ($pegawai->riwayatjabatanft as $rjbtft)
                                    <form action="/pegawai/jabatanfungsionalt/hapus/{{ $rjbtft->id_jbtft }}"
                                        ...
                                        <button type="submit" class="btn btn-danger btn-sm m-2">Hapus data dgn no. sk
                                            {{ $rjbtft->no_sk }}</button>
                                    </form>
                                @endforeach
                                <!-- end hapus diklat -->
