...
@section('konten')
    ...
    <div class="container-fluid">
        ...
        <div class="alert alert-warning" role="alert">
            <h4 class="alert-heading">Notifikasi!</h4>
            <p>Selamat datang di SKY SIMPEG (Sistem Kepegawaian Sekolah Kristen Yahya)</p>
            <p class="mb-0">Anda tidak dapat langsung mengatur profil anda <strong> hubungi admin pusat </strong>
                untuk mengaitkan akun anda dengan data kepegawaian anda</p>
        </div>
