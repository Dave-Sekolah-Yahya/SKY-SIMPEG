...
@section('title', 'SKY SIMPEG - Pendidikan')
@section('konten')
                            ...
                            <thead>
                                <tr role="row">
                                    <th class="sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1"
                                        ...
                                        aria-label="Name: activate to sort column descending">Kode Pendidikan</th>
                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                        colspan="1" style="width: 248px;"
                                        aria-label="Position: activate to sort column ascending">Pendidikan</th>
                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                        colspan="1" style="width: 248px;"
                                ...
                                @foreach ($pdd as $d)
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <!-- Button trigger modal -->
                                            <!-- Button trigger modal -->
                                            <a href="/data/tmpendidikan/hapus/{{ $d->kode_pdd }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card p-3">
                        <form action="/data/tmpendidikan/tambah/proses" method="post">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-6">
