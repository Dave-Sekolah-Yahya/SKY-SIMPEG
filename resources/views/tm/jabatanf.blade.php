...
@section('title', 'SKY SIMPEG - Jabatan Fungsional')
@section('konten')
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                        ...
                                        aria-label="Position: activate to sort column ascending">Nama Jabatan</th>
                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                        colspan="1" style="width: 248px;"
                                ...
                                @foreach ($jbtf as $d)
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <!-- Button trigger modal -->
                                            <!-- Button trigger modal -->
                                            <a href="/pegawai/tmgolongan/hapus/{{ $d->kode_jbtf }}"
